...
data class ArbeidsgiverFerdigstiltOppfolgingsplanResponseData(
    val id: UUID,
...
data class ArbeidsgiverFerdigstiltOppfolgingsplanResponse(
    val userHasEditAccess: Boolean,
    val organization: OrganizationDetails,
    val employee: EmployeeDetails,
    val oppfolgingsplan: ArbeidsgiverFerdigstiltOppfolgingsplanResponseData,
    val hasUtkast: Boolean
)
