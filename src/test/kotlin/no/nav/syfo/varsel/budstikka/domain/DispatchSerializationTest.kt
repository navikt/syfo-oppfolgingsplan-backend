        ...
        describe("dispatchJson") {
            it("serializes BrukervarselCreate with stable type name and inline personIdentifier") {
                ...
                dispatchJson.encodeToString(dispatch) shouldBe
                    """{"eventId":"5fbc039e-b104-4554-809f-337d7ef804d0","reference":"0a5c80b8-2350-4f2a-b0e7-d1b796c6c8d4","content":{"type":"BrukervarselCreate","personIdentifier":"12345678901","varseltype":"BESKJED","text":"$OPPFOLGINGSPLAN_CREATED_BUDSTIKKA_TEXT","link":null,"visibleUntil":null,"externalVarsling":null,"brevFallback":null,"sendingWindow":null}}"""
            }
